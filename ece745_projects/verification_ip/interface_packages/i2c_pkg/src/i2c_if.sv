...
// ****************************************************************************
task monitor ( output bit [I2C_ADDR_WIDTH-1:0]  addr, output i2c_op_t op, output bit [I2C_DATA_WIDTH-1:0] data [], output bit addr_ack, output bit stop_seen);
begin
    bit read_done;
    bit [I2C_ADDR_WIDTH:0] addr_temp;
    bit [I2C_DATA_WIDTH - 1:0] data_temp;
    ...
    begin
        ...
        begin
            ...
            addr = addr_temp[I2C_ADDR_WIDTH:1];
