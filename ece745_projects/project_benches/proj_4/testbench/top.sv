...
tri1  [0:NUM_I2C_BUSSES-1] scl;
triand  [0:NUM_I2C_BUSSES-1] sda;
...
i2cmb_test test;  // instantiating test

// Define the flow of the simulation
initial begin : test_flow

//Place virtual interface handles into ncsu_config_db
ncsu_config_db#(v_wb_if)::set("wb_interface", wb_bus);
ncsu_config_db#(v_i2c_if)::set("i2c_interface", i2c_bus);
